...
set ip_dir $origin_dir/ip_repo
set pixelRadiation_dir $origin_dir/../pixelRadiation
...
set ip_files [list \
  "[file normalize $ip_dir]"\
  "[file normalize $repo_dir]"\
  "[file normalize $pixelRadiation_dir]"]
#set_property "ip_repo_paths" "[file normalize $ip_dir]" $obj
set_property "ip_repo_paths" $ip_files $obj
...
#set_property STEPS.SYNTH_DESIGN.ARGS.FLATTEN_HIERARCHY none [get_runs hdmi_pixelRadiation_0_0_synth_1]
#set_property STEPS.SYNTH_DESIGN.ARGS.DIRECTIVE RuntimeOptimized [get_runs hdmi_pixelRadiation_0_0_synth_1]
