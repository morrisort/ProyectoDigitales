...
HD_PWD='/home/andrew/Documents/proyecto-Digitales/formaLenta/pixelRadiation/pixelRadiation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixelRadiation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixelRadiation.tcl
