...
HD_PWD='/home/andrew/Documents/pixelRadiation/pixelRadiation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pixelRadiation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pixelRadiation.tcl -notrace
